...
function ComparisonSwipeLayer({
  ...
  return (
    <Pane name={paneName} style={{ zIndex: 260 }}>
      <TileLayer
          ...
          <div className="mv-map-canvas" ref={mapCanvasRef}>
            <MapContainer {...mapProps} style={{ height: '100%', width: '100%' }}>
              ...
              <ActiveLayerBoundsController
                ...
                triggerKey={splitView ? `${comparisonFitKey}|refresh-${comparisonRefreshTick}` : `${cogTileUrl || 'none'}-${zoomTrigger}`}
              />
              <MapPane
                measureMode={measureMode}
              ...
              {splitView && compareCogTileUrl ? (
                <ComparisonSwipeLayer
                  key={`comparison-layer-${compareCogTileUrl}-${comparisonRefreshTick}`}
